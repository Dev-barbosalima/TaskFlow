...
public class MainActivity extends AppCompatActivity {
                ...
                deletar.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        AlertDialog a = new AlertDialog.Builder(MainActivity.this)
                                .setIcon(android.R.drawable.ic_dialog_alert).setTitle("Deletar")
                                .setMessage("Deseja reamente deletar a tarefa?")
                                .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        AppDatabase.getAppDatabase(MainActivity.this).tarefaDAO().deletar(tarefaSelecionada);
                                        atualizarLista();
                                        Snackbar.make(findViewById(R.id.lsvListarTarefas), "Deletado com Sucesso", Snackbar.LENGTH_LONG).show();
                                    }
                                })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (resultCode == RESULT_OK && requestCode == 1){
            ...
            Snackbar.make(findViewById(R.id.lsvListarTarefas), "Tarefa alterada com sucesso!", Snackbar.LENGTH_LONG).show();
        }
    }
}